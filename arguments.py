...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--critic-time", type=int, help="Number of critic updates")
    group.add_argument("--lambda-gp", type=float, help="Weight for gradient penalty")
    ...
    group.add_argument("--max-input-len", type=int, default=1024)
...
def add_runtime_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--generate-tsne-plot", action="store_true", help="Generate and save t-SNE plot after training.")
    return parser
